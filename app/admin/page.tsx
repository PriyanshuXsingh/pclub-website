...
export default function AdminPage() {
  ...
  const Card: React.FC<{ user: User; actions?: boolean }> = ({
    ...
    return (
      <div className="w-full max-w-md rounded-xl bg-white p-4 text-black shadow-md">
        <p>
      ...
      <section className="mb-12 w-full max-w-5xl">
        ...
        <div className="grid grid-cols-1 gap-6 sm:grid-cols-2 lg:grid-cols-3">
          {pendingUser.length ? (
            ...
            <p className="col-span-full text-slate-600">No pending requests</p>
          )}
        </div>
      </section>
      ...
      <section className="mb-12 w-full max-w-5xl">
        ...
        <div className="grid grid-cols-1 gap-6 sm:grid-cols-2 lg:grid-cols-3">
          {approveUser.length ? (
            ...
            <p className="col-span-full text-slate-600">No admins yet</p>
          )}
        </div>
      </section>
      ...
      <section className="w-full max-w-5xl">
        ...
        <div className="grid grid-cols-1 gap-6 sm:grid-cols-2 lg:grid-cols-3">
          {rejectUser.length ? (
            ...
            <p className="col-span-full text-slate-600">No rejected users</p>
          )}
        </div>
      </section>
    </div>
